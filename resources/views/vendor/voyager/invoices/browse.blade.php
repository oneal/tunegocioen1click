                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            @endforeach
                                            @if ($data->paid == 0)
                                                <a href="{{ route('invoice.paid', ['id' => $data->id]) }}" class="btn btn-danger"><span class="icon voyager-documentation"></span> Pagar</a>
                                            @endif
                                            <a href="{{ route('invoice.generarteinvoicepdf', ['id' => $data->id]) }}" class="btn btn-dark"><span class="icon voyager-documentation"></span> Ver</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
