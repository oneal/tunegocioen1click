...
@section('page_title', 'Listado posiciones hoteles')

@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="voyager-list"></i> Listado posiciones hoteles
            <a href="{{ url('admin/hotels/create') }}" class="btn btn-success btn-add-new">
...
@section('content')
    <div class="page-content container-fluid">
        <?php $categories = $hotelCategories;?>
...
@section('javascript')
    <script type="application/javascript">
        function searchPositions(){
            ...
            var url = '{{ route("hotels.listPositionHotels")}}';
