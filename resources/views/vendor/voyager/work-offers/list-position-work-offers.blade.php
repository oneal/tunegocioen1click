...
@section('page_title', 'Listado posiciones ofertas de trabajo')

@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="voyager-list"></i> Listado posiciones ofertas de trabajo
            <a href="{{ url('admin/work-offers/create') }}" class="btn btn-success btn-add-new">
...
@section('content')
    <div class="page-content container-fluid">
        <?php $categories = $workOfferCategories;?>
...
@section('javascript')
    <script type="application/javascript">
        function searchPositions(){
            ...
            var url = '{{ route("workoffers.listPositionWorkOffers")}}';
