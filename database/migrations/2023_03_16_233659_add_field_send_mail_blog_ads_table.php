...
class AddFieldSendMailBlogAdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropColumns('blogs_ads', ['send_email_expired_15_days','send_email_expired_10_days','send_email_expired_5_days']);
    }
}
